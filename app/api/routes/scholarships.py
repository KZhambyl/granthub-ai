...
@router.post("/", response_model=scholarship.ScholarshipRead, status_code=status.HTTP_201_CREATED)
...
@router.patch("/{scholarship_id}", response_model=scholarship.ScholarshipRead, status_code=status.HTTP_202_ACCEPTED)
